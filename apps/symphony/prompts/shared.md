...
Use the built-in Linear tools (`linear_get_issue`, `linear_list_workflow_states`, `linear_update_issue`, `linear_add_comment`, etc.) for all Linear operations. Do NOT use MCP Linear tools — they consume excessive context.
