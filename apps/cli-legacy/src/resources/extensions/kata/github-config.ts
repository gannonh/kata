...
export type GithubStateMode = "projects_v2";
  ...
  if (githubProjectNumber === undefined) {
    return {
      ...
      diagnostic: {
        code: "invalid_github_project_number",
        message:
          "github.githubProjectNumber is required for GitHub Projects v2. Set github.stateMode: projects_v2 and github.githubProjectNumber to a positive integer.",
        field: "github.githubProjectNumber",
        retryable: false,
      },
    };
...
function getGithubDiagnosticAction(
  ...
  switch (diagnostic.code) {
    ...
    case "invalid_github_project_number":
      return "set github.githubProjectNumber to a positive integer.";
    case "invalid_state_mode":
      return 'set github.stateMode to "projects_v2".';
    default:
      return null;
  }
}
