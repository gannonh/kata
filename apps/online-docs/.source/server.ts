// @ts-nocheck
import * as __fd_glob_25 from "../content/docs/visual-explainers/index.mdx?collection=docs"
import * as __fd_glob_24 from "../content/docs/symphony/index.mdx?collection=docs"
import * as __fd_glob_23 from "../content/docs/orchestrator/index.mdx?collection=docs"
import * as __fd_glob_22 from "../content/docs/desktop/index.mdx?collection=docs"
...
import { default as __fd_glob_5 } from "../content/docs/desktop/meta.json?collection=docs"
...
import { default as __fd_glob_2 } from "../content/docs/context/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "architecture/meta.json": __fd_glob_1, "context/meta.json": __fd_glob_2, "cli/meta.json": __fd_glob_3, "getting-started/meta.json": __fd_glob_4, "desktop/meta.json": __fd_glob_5, "orchestrator/meta.json": __fd_glob_6, "symphony/meta.json": __fd_glob_7, "visual-explainers/meta.json": __fd_glob_8, }, {"index.mdx": __fd_glob_9, "architecture/conventions.mdx": __fd_glob_10, "architecture/index.mdx": __fd_glob_11, "architecture/packages.mdx": __fd_glob_12, "cli/agents.mdx": __fd_glob_13, "cli/commands.mdx": __fd_glob_14, "cli/extensions.mdx": __fd_glob_15, "cli/index.mdx": __fd_glob_16, "cli/kata-workflow.mdx": __fd_glob_17, "cli/preferences.mdx": __fd_glob_18, "context/index.mdx": __fd_glob_19, "getting-started/installation.mdx": __fd_glob_20, "getting-started/quickstart.mdx": __fd_glob_21, "desktop/index.mdx": __fd_glob_22, "orchestrator/index.mdx": __fd_glob_23, "symphony/index.mdx": __fd_glob_24, "visual-explainers/index.mdx": __fd_glob_25, });