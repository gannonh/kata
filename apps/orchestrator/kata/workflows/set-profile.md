<purpose>
Switch the model profile used by Kata agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in kata-tools.cjs for selected profile]
