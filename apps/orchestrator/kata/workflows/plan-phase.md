<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates kata-phase-researcher, kata-planner, and kata-plan-checker agents with a revision loop (max 3 iterations).
</purpose>

<required_reading>
Read all files referenced by the invoking prompt's execution_context before starting.

@~/.claude/kata-orchestrator/references/ui-brand.md
</required_reading>
...
```bash
INIT=$(node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" init plan-phase "$PHASE")
...
**If `planning_exists` is false:** Error — run `/kata:new-project` first.
...
```bash
PHASE_INFO=$(node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" roadmap get-phase "${PHASE}")
```
...
5. Commit:
```bash
node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" commit "docs(${padded_phase}): generate context from PRD" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
...
If "Run discuss-phase first": Display `/kata:discuss-phase {X}` and exit workflow.
...
```bash
PHASE_DESC=$(node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" roadmap get-phase "${PHASE}" | jq -r '.section')
```
...
<files_to_read>
- {context_path} (USER DECISIONS from /kata:discuss-phase)
...
**If found:**
1. Read template: `~/.claude/kata-orchestrator/templates/VALIDATION.md`
...
1. Re-run: `/kata:plan-phase {PHASE} --research`
...
<downstream_consumer>
Output consumed by /kata:execute-phase. Plans need:
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Kata ► AUTO-ADVANCING TO EXECUTE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
Skill(skill="kata:execute-phase", args="${PHASE} --auto --no-transition")
```
...
- **PHASE COMPLETE** → Display final summary:
  ```
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Kata ► PHASE ${PHASE} COMPLETE ✓
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  Auto-advance pipeline finished.

  Next: /kata:discuss-phase ${NEXT_PHASE} --auto
  ```
...
- [ ] kata-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] kata-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] kata-plan-checker spawned with CONTEXT.md
