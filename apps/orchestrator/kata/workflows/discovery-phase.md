...
See ~/.claude/kata-orchestrator/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/kata-orchestrator/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/kata-orchestrator/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/kata-orchestrator/templates/discovery.md
...
Use ~/.claude/kata-orchestrator/templates/discovery.md.
