...
<!-- For checkpoint task examples and patterns, see @~/.claude/kata-orchestrator/references/checkpoints.md -->
...
See `~/.claude/kata-orchestrator/references/tdd.md` for TDD plan structure.
...
See `~/.claude/kata-orchestrator/templates/user-setup.md` for full schema and examples
...
See `~/.claude/kata-orchestrator/workflows/verify-phase.md` for verification logic.
