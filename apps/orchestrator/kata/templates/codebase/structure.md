...
**New Template:**
- Implementation: `kata-orchestrator/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `kata-orchestrator/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/kata-orchestrator/workflows/{name}.md`

**New Reference Document:**
- Implementation: `kata-orchestrator/references/{name}.md`
