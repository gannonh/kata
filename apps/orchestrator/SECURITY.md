...
Instead, please report them via email to: **security@kata.build** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the Kata codebase that could:
