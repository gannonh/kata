...
Reference full template: `~/.claude/kata-orchestrator/templates/roadmap.md`

## STATE.md Structure

Use template from `~/.claude/kata-orchestrator/templates/state.md`.
