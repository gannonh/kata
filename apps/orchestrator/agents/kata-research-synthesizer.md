...
# Planning config loaded via kata-tools.cjs in commit step
```
...
```bash
node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" commit "docs: complete project research" --files .planning/research/
```
