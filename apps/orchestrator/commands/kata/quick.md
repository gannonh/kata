...
---
<objective>
Execute small, ad-hoc tasks with Kata guarantees (atomic commits, STATE.md tracking).
...
<execution_context>
@~/.claude/kata-orchestrator/workflows/quick.md
</execution_context>
...
<process>
Execute the quick workflow from @~/.claude/kata-orchestrator/workflows/quick.md end-to-end.
