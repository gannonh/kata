...
```bash
node ./scripts/kata-call.mjs artifact.list --input /tmp/kata-PROJECT-artifacts.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.list --input /tmp/kata-M001-artifacts.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.read --input /tmp/kata-read-milestone-requirements.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.read --input /tmp/kata-read-milestone-roadmap.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.read --input /tmp/kata-read-named-artifact.json
```
...
node ./scripts/kata-call.mjs artifact.write --input /tmp/kata-M001-roadmap.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.write --input /tmp/kata-M001-requirements.json
```
