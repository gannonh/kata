...
```bash
node ./scripts/kata-call.mjs slice.list --input /tmp/kata-M001-slice-list.json
```
...
```bash
node ./scripts/kata-call.mjs task.list --input /tmp/kata-S001-task-list.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.read --input /tmp/kata-S001-read-plan.json
```
...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-S001-slice-approved.json
```
...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-S001-slice-in-progress.json
```
...
```bash
node ./scripts/kata-call.mjs task.updateStatus --input /tmp/kata-T001-task-in-progress.json
```
...
```bash
node ./scripts/kata-call.mjs artifact.write --input /tmp/kata-T001-task-summary.json
```
...
```bash
node ./scripts/kata-call.mjs task.updateStatus --input /tmp/kata-T001-task-done.json
```
...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-S001-slice-done.json
```
