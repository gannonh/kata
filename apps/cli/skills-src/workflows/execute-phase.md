...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-slice-approved.json
```
...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-slice-in-progress.json
```
...
```bash
node ./scripts/kata-call.mjs slice.updateStatus --input /tmp/kata-slice-done.json
```
