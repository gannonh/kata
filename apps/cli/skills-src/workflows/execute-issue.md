...
```bash
node ./scripts/kata-call.mjs issue.updateStatus --input /tmp/kata-issue-updateStatus.json
```
...
```bash
node ./scripts/kata-call.mjs issue.updateStatus --input /tmp/kata-issue-done.json
```
