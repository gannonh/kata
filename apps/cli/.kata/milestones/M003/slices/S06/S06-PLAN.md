...
- [ ] **T01: Write failing tests for Linear cross-linking helpers** `est:30m`
...
- [ ] **T02: Implement cross-linking helpers and wire into PR body composition** `est:1h`
...
- [ ] **T03: Wire cross-linking into PR creation and merge tool handlers** `est:1h`
