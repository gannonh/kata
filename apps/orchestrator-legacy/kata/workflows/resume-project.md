...
<required_reading>
@~/.claude/kata-orchestrator/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" init resume)
...
**If `planning_exists` is false:** This is a new project - route to /kata:new-project
</step>
