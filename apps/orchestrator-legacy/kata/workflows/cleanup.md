...
```bash
node "$HOME/.claude/kata-orchestrator/bin/kata-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
