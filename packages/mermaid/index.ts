/**
 * Generates index.html showcasing all @kata/mermaid rendering capabilities.
 *
...
<head>
  ...
  <!-- Analytics disabled for the Kata fork -->
    ...
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://github.com/gannonh/kata-agents" class="brand-dropdown-item" target="_blank" rel="noopener">
          ...
          <span style="margin-left: -2px;">Kata<span class="tagline">AI Agent Platform</span></span>
        </a>
