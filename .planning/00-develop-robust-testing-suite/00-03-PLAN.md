...
```bash
test -f tests/skills/adding-todos.test.js && test -f tests/skills/checking-todos.test.js && echo "Files created"
```
...
After creating the test files, verify they exist:
```bash
test -f tests/skills/pausing-work.test.js && test -f tests/skills/resuming-work.test.js && echo "Files created"
```
Then run the tests (requires ANTHROPIC_API_KEY):
```bash
...
After creating the test files, verify they exist:
```bash
test -f tests/skills/configuring-settings.test.js && test -f tests/skills/setting-profiles.test.js && echo "Files created"
```
Then run the tests (requires ANTHROPIC_API_KEY):
```bash
...
ls -la tests/skills/adding-todos.test.js tests/skills/checking-todos.test.js tests/skills/pausing-work.test.js tests/skills/resuming-work.test.js tests/skills/configuring-settings.test.js tests/skills/setting-profiles.test.js

# Run all Wave 2 project management skill tests (requires ANTHROPIC_API_KEY)
