...
```bash
test -f tests/skills/planning-phases.test.js && test -f tests/skills/executing-phases.test.js && echo "Files created"
```
...
After creating the test files, verify they exist:
```bash
test -f tests/skills/verifying-work.test.js && test -f tests/skills/researching-phases.test.js && echo "Files created"
```
Then run the tests (requires ANTHROPIC_API_KEY):
```bash
...
After creating the test files, verify they exist:
```bash
test -f tests/skills/executing-quick-tasks.test.js && test -f tests/skills/planning-milestone-gaps.test.js && echo "Files created"
```
Then run the tests (requires ANTHROPIC_API_KEY):
```bash
...
ls -la tests/skills/planning-phases.test.js tests/skills/executing-phases.test.js tests/skills/verifying-work.test.js tests/skills/researching-phases.test.js tests/skills/executing-quick-tasks.test.js tests/skills/planning-milestone-gaps.test.js

# Run all Wave 4 execution workflow skill tests (requires ANTHROPIC_API_KEY)
