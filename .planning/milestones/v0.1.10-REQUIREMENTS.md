...
- [ ] **CFG-03**: Integration config set during `/kata:project-new` onboarding

### GitHub Milestones

- [ ] **GHM-01**: `/kata:milestone-new` creates corresponding GitHub Milestone
...
- [ ] **GHP-01**: `/kata:phase-execute` creates PR at phase completion
