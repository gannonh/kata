# Requirements Archive: v1.9.0 Template Overrides (Universal)
...
- [x] **VAL-01**: Template drift detection runs in skills (not SessionStart hooks)
- [x] **VAL-02**: Config validation runs in skills (not SessionStart hooks)
- [x] **VAL-03**: Validation works universally for plugin + skills-only users
- [x] **VAL-04**: SessionStart hooks removed after validation migration complete
...
---
*Archived: 2026-02-08 as part of v1.9.0 milestone completion*
