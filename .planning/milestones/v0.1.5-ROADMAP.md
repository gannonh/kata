...
**Success Criteria** (what must be TRUE):
  1. 8 skills created: kata-planning-phases, kata-execution, kata-verification, kata-starting-project-news, kata-manageing-milestones, kata-managing-project-roadmap, kata-researching-phases, kata-utility
...
- [x] 00-04-PLAN.md — Create kata-starting-project-news skill
...
**Goal**: Create `kata-managing-todos` skill to handle todo capture and management, migrating functionality from GSD's `todos-add` and `todos-lists` commands
