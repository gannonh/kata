...
must_haves:
  truths:
    - "User can invoke /kata-roadmap-management skill from natural language"
    - "Skill handles add-phase, insert-phase, remove-phase, plan-milestone-gaps"
  ...
  artifacts:
    - path: "skills/kata-roadmap-management/SKILL.md"
      ...
      max_lines: 500
    - path: "skills/kata-roadmap-management/references/phase-operations.md"
      provides: "Add, insert, remove phase workflows"
    - path: "skills/kata-roadmap-management/references/decimal-numbering.md"
      provides: "Decimal phase numbering for urgent insertions"
  key_links:
    - from: "skills/kata-roadmap-management/SKILL.md"
...
<objective>
Create the kata-roadmap-management skill for roadmap operations.

Purpose: Handles adding phases, inserting urgent phases (decimal numbering), removing phases, and planning milestone gaps.

Output: skills/kata-roadmap-management/ directory with SKILL.md and references/
</objective>
...
<task type="auto">
  <name>Task 1: Create kata-roadmap-management skill with references</name>
  <files>
    skills/kata-roadmap-management/SKILL.md
    skills/kata-roadmap-management/references/phase-operations.md
    skills/kata-roadmap-management/references/decimal-numbering.md
  ...
  <action>
Create the kata-roadmap-management skill following /building-claude-code-skills methodology:

1. Create skills/kata-roadmap-management/SKILL.md:
   - Frontmatter: name (kata-roadmap-management), description (trigger-focused, 3rd person)
...
- commands/kata/add-phase.md (has add workflow)
- commands/kata/insert-phase.md (has insert workflow, decimal numbering)
- commands/kata/remove-phase.md (has remove workflow)
- commands/kata/plan-milestone-gaps.md (has gap planning)
- agents/kata-roadmapper.md (has roadmap operations)
  ...
  <verify>
    ...
    - wc -l skills/kata-roadmap-management/SKILL.md shows less than 500 lines
    - grep "name: kata-roadmap-management" skills/kata-roadmap-management/SKILL.md returns match
    - grep "Task" skills/kata-roadmap-management/SKILL.md shows sub-agent spawning
    - ls skills/kata-roadmap-management/references/ shows 3 files
  </verify>
  <done>
...
<success_criteria>
- skills/kata-roadmap-management/SKILL.md exists with orchestrator workflow
- skills/kata-roadmap-management/references/ contains 3 reference files
