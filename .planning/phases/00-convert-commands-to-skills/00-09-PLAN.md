...
3. Update the "Making Changes to Kata" section:
  ...
  <verify>
    ...
    - grep "kata-planning" CLAUDE.md returns match
...
2. Verify all 8 skill directories exist:
   ...
   ls .claude/skills/
   ```
   Expected: kata-planning, kata-execution, kata-verification, kata-project-initialization,
             kata-milestone-management, kata-roadmap-management, kata-research, kata-utility
