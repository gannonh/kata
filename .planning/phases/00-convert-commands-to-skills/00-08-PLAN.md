...
must_haves:
  truths:
    ...
    - "Skill handles progress, debug, resume-work, pause-work, map-codebase operations"
...
- commands/kata/pause-work.md (has pause workflow)
- commands/kata/resume-work.md (has resume workflow)
- commands/kata/map-codebase.md (has mapping workflow)
