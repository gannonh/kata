...
must_haves:
  truths:
    - "User can invoke /kata-planning skill from natural language"
  ...
  artifacts:
    ...
    - path: "bin/install.js"
      ...
      contains: "skills"
  key_links:
    - from: "skills/kata-planning/SKILL.md"
...
<objective>
Create the kata-planning skill and update the installer to support skills.
...
Output:
- skills/kata-planning/ directory with SKILL.md and references/
...
<task type="auto">
  <name>Task 1: Create kata-planning skill with references</name>
  <files>
    skills/kata-planning/SKILL.md
    skills/kata-planning/references/task-breakdown.md
    skills/kata-planning/references/dependency-graph.md
  ...
  <action>
Create the kata-planning skill following /building-claude-code-skills methodology:

1. Create skills/kata-planning/SKILL.md:
   - Frontmatter: name (kata-planning), description (trigger-focused, 3rd person, includes "plan phase", "create execution plan", "task breakdown", "dependency analysis", "wave assignment")
...
- kata/workflows/plan-phase.md (has workflow logic)
- commands/kata/plan-phase.md (has orchestration flow)
  </action>
  <verify>
    - ls skills/kata-planning/ shows SKILL.md and references/ directory
    - wc -l skills/kata-planning/SKILL.md shows less than 500 lines
    - grep "name: kata-planning" skills/kata-planning/SKILL.md returns match
    - grep "Task" skills/kata-planning/SKILL.md shows sub-agent spawning
  </verify>
  <done>
...
- Follows the same pattern as agents copying
  ...
  <verify>
    ...
    - ls .claude/skills/kata-planning/ shows installed skill
  </verify>
  <done>
    ...
    - Local install test shows skills/kata-planning/ installed correctly
  </done>
</task>
...
<success_criteria>
- skills/kata-planning/SKILL.md exists with orchestrator workflow
- skills/kata-planning/references/ contains 4 reference files
