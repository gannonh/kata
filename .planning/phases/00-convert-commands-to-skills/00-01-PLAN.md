...
<task type="auto">
  ...
  <verify>
    ...
    ls .claude/skills/kata-planning/SKILL.md exists after install.
  </verify>
  <done>Install script copies skills directory to .claude/skills/</done>
</task>
...
5. `ls .claude/skills/kata-planning/` shows skill installed
</verification>
...
- [ ] Local install succeeds and skill is accessible
</success_criteria>
