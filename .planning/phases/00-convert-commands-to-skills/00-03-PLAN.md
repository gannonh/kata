...
<task type="auto">
  ...
  <action>
    ...
    **agents/kata-debugger.md:**
    - Add `skills: kata-verification, kata-debugging` to frontmatter
    - Keep debugging-specific logic
    - Reference skill for verification context
  ...
  <verify>
    ...
    grep "skills:" agents/kata-debugger.md succeeds.
...
- [ ] kata-debugger agent has skills: kata-verification in frontmatter
