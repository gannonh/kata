...
provides: [kata-customize-skill, template-list-discovery, template-override-management]
...
key-files:
  created:
    ...
    - skills/kata-customize/SKILL.md
  modified:
...
key-decisions:
  ...
  - Alphabetical ordering in help (kata-customize before kata-configure-settings)
...
Self-service /kata-customize skill with list, copy, edit, validate operations using list-templates.sh for dynamic schema-backed template discovery.
...
2. Created `kata-customize/SKILL.md` (235 lines) with four operations: list (table display), copy (with overwrite protection via AskUserQuestion), edit (read/modify/validate cycle), validate (runs check-template-drift.sh)
3. Added `/kata-customize` entry to kata-help Configuration section with usage examples and `.planning/templates/` to the Files & Structure tree

## Task Commits

| Task | Name                                      | Commit  | Files                                           |
| ---- | ----------------------------------------- | ------- | ----------------------------------------------- |
| 1    | Create list-templates.sh helper script    | 5e80c7f | skills/kata-customize/scripts/list-templates.sh |
| 2    | Create kata-customize SKILL.md            | efdce23 | skills/kata-customize/SKILL.md                  |
| 3    | Add kata-customize to kata-help reference | ea3cc4e | skills/kata-help/SKILL.md                       |

## Files Created/Modified

**Created:**
- `skills/kata-customize/scripts/list-templates.sh` — Template discovery script, sibling scanning, JSON output
- `skills/kata-customize/SKILL.md` — Four-operation skill (list, copy, edit, validate)
...
- **Files modified:** skills/kata-customize/scripts/list-templates.sh
- **Commit:** 5e80c7f
