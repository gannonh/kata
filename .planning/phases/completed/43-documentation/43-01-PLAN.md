...
grep -q "kata-customize list" README.md && echo "OK" || echo "FAIL: missing list example"
grep -q "kata-customize copy" README.md && echo "OK" || echo "FAIL: missing copy example"
grep -q "kata-customize validate" README.md && echo "OK" || echo "FAIL: missing validate example"
