...
<task type="auto">
  ...
  <verify>
    grep -n "phases/pending" skills/kata-new-project/SKILL.md skills/kata-add-phase/SKILL.md skills/kata-insert-phase/SKILL.md
...
<task type="auto">
  ...
  <action>
    **Universal Phase Discovery Pattern** — Use this exact pattern in both files wherever phase directories are looked up:
    ```bash
