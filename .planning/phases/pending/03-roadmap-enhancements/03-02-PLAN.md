...
must_haves:
  truths:
    - "Future ROADMAP.md files include Planned Milestones section with consistent format"
    - "Archived milestones in ROADMAP.md use consistent details block format with Goal line and archive link"
...
@.planning/phases/pending/03-roadmap-enhancements/03-01-SUMMARY.md
</context>
...
- `grep "○" agents/kata-roadmapper.md` returns a match (circle symbol for planned)
  </verify>
...
- Symbol vocabulary (✅ 🔄 ○) documented in both skills and agent (ROAD-02)
</success_criteria>
