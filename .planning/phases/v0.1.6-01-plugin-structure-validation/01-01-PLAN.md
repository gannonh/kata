...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/v0.1.6-01-plugin-structure-validation/01-RESEARCH.md
</context>
...
<output>
After completion, create `.planning/phases/v0.1.6-01-plugin-structure-validation/01-01-SUMMARY.md`
</output>
