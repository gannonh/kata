---
name: visual-explainer-geistdocs
description: Kata-specific extension of the visual-explainer skill with the Geistdocs preset for generating HTML pages that embed in the Kata docs site. Use when generating visual explainers intended for apps/online-docs or when the geistdocs theme is needed. Extends the user-level visual-explainer skill with Kata branding, Fumadocs palette, and postMessage theme sync.
---
